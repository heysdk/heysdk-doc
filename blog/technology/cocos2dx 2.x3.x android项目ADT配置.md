...
ADT中右击工程名->Properties->Java Build Path->Source->Link Source->Browse。

找到Cocos2d-x引擎根目录下cocos/platform/android/java/src，导入，名字给libcocos2dx，点击finish，OK。
...
步骤还是有点多的，可以试试我们的heysdktools工具包，执行 proccc2proj.cmd 或者 proccc2proj.sh 可以一键搞定项目。